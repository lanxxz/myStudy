package com.alien.manacheralgorithm;
 ...
 *
 * @author: alien
 * @since: 2020/03/08 20:56
 */
public class Solution {
    public static void main(String[] args) {
        System.out.println(Arrays.toString(calSubstrings("abcdefg")));
        System.out.println(Arrays.toString(calSubstrings("cbcbccde")));
    }

    public static int[] calSubstrings(String s) {
        if (s.length() == 0) {
            return new int[0];
        }
        // 存放新的内容
